...
`));n("ffd6");let h,x,D,C,I,O,j,L,R,z,Q,U,T,B,N,E,P=e=>e;const F=Object(s["a"])(h||(h=P`
  mutation(
    $username: String
    $fullname: String
    $password: String
