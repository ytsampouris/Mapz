...
`));let d,o,c,u,p,m,$,g,b=e=>e;const y=Object(r["a"])(d||(d=b`
  query getLayers {
    layers {
      id
      label
...
`));i("ffd6");let x,D,h,I,w,O,j,Q,z,U,C,B,T,P,F,N,A=e=>e;const J=Object(r["a"])(x||(x=A`
  mutation(
    $username: String
    $fullname: String
    $password: String
